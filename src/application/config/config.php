...
/*
|--------------------------------------------------------------------------
| TekhneeAppointments - Internal Configuration
|--------------------------------------------------------------------------
|
| Declare some of the global config values of TekhneeAppointments.
|
*/
$config['version'] = '%%GULP_INJECT_VERSION%%';
...
$config['available_languages'] = array (
	...
	'en-US-POSIX' => ['english', '', 'English', 'en-US-POSIX', 'en-us', 'en'],
	'en-GB' => ['english', '', 'English (UK)', 'en-GB', 'en-gb', 'en'],
	...
	'hu' => ['hungarian', '', 'Magyar', 'hu', 'hu', 'hi'],
	'it' => ['italian', '', 'Italiano', 'it', 'it', 'it'],
	'ja' => ['japanese', '', '日本語', 'ja', 'ja', 'ja'],
	'lb' => ['luxembourgish', '', 'Lëtzebuergesch', 'lb', 'lb', 'lb'],
	'pl' => ['polish', '', 'Polski', 'pl', 'pl', 'pl'],
	'pt' => ['portuguese', '', 'Português', 'pt', 'pt', 'pt'],
	'pt-BR' => ['portuguese-br', '', 'Português brasileiro', 'pt-BR', 'pt', 'pt-BR'],
...
(isset($_SERVER['HTTP_ACCEPT_LANGUAGE'])) ? $servlang = $_SERVER['HTTP_ACCEPT_LANGUAGE'] : $servlang = '';
$config['language'] = ( ('' !== $servlang &&
						 array_key_exists(strtolower(substr($servlang, 0, 5)), $config['available_languages']) )
							?
							strtolower(substr($servlang, 0, 5))
							:
							(array_key_exists(strtolower(substr($servlang, 0, 2)), $config['available_languages'])
								?
								strtolower(substr($servlang, 0, 2))
								:
...
$config['sess_cookie_name'] = 'tekhnee_appointments_session';
