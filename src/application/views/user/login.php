    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#login-form').submit(function(event) {
                ...
                var postUrl = GlobalVariables.baseUrl + /* @mangle */ '/index.php/user/ajax_check_login' /* @/mangle */ ;
                var postData = {
                    'csrfToken': GlobalVariables.csrfToken,
                    /* @mangle */
                    'username' /* @/mangle */: $( /* @mangle */ '#username' /* @/mangle */ ).val(),
                    /* @mangle */
                    'password' /* @/mangle */: $( /* @mangle */ '#password' /* @/mangle */ ).val()
                };
