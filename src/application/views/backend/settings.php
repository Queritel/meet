    ...
    <div class="tab-content">
                ...
                <fieldset>
                    <legend>
                        ...
                        <?php if ($privileges[PRIV_SYSTEM_SETTINGS]['edit'] == TRUE) : ?>
                            <button type="button" class="save-settings btn btn-primary btn-xs" title="<?= lang('save') ?>">
                    ...
                    <div class="wrapper row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="google-analytics-code" placeholder="UA-XXXXXXXX-X" data-field="google_analytics_code" class="form-control">
                                <span class="help-block">
        ...
        <div role="tabpanel" class="tab-pane" id="about-app">
            ...
            <p>
                ...
                <a href="https://meeting.tekhnee.org/">
                    <?= lang('official_website') ?>
                </a>
                |
                <a href="https://github.com/tekhnee/appointments/issues">
                    <?= lang('project_issues') ?>
                </a>
                |
                <a href="https://tekhnee.org/">
                    E!A Blog
                </a>
            </p>
