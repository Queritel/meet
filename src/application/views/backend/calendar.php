...
<link rel="stylesheet" type="text/css" href="<?= asset_url('/assets/ext/flatpickr/material_green.css') ?>">
...
<script src="<?= asset_url('/assets/js/timezone_switch_backend.js') ?>"></script>
<script src="<?= asset_url('/assets/ext/flatpickr/flatpickr.min.js') ?>"></script>
<script src="<?= asset_url("/assets/ext/flatpickr/l10n/{$this->config->item('available_languages')[$this->config->item('language')][4]}.js") ?>"></script>
...
<div id="calendar-page" class="container-fluid">
    <div id="calendar-toolbar">
        <div id="calendar-filter" class="form-inline col-xs-12 col-sm-3">
        ...
        <div id="calendar-actions" class="col-xs-12 col-sm-9">
    ...
    <div style="visibility: hidden;" id="timezone-selector">
...
<div id="manage-appointment" class="modal fade" data-focus="false" data-keyboard="true">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <input id="hidden-timezone" type="hidden">
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="phone-number" class="control-label"><?= lang('phone_number') ?><?php echo ('1' === $require_phone_number) ? '*' : ''; ?></label>
                                    <input id="phone-number" class="<?php echo ('1' === $require_phone_number) ? 'required' : ''; ?>
                                        form-control">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
...
<div id="manage-unavailable" class="modal fade" data-focus="false">
