...
$lang['about_app'] = 'TekhneeAppointments-ról';
...
$lang['about_app_info'] = 'TekhneeAppointments egy könnyen testreszabható webes alkalmazás mely lehetővé teszi, hogy ügyfelek weben keresztül időpontokat foglalhassanak. Ezen felül lehetővé teszi, hogy szinkronizáljuk a foglalások adatait a Google naptárunkkal, így más szolgáltatásokkal is használható.';
$lang['current_version'] = 'Jelenlegi verzió';
$lang['support'] = 'Támogatás';
$lang['about_app_support'] = 'Amennyiben problémákba ütközöl az TekhneeAppointments használata közben, úgy a hivatalos Google Group-ban tudsz válaszokat keresni. Előfordulhat, hogy egy új lapot kell nyitnod a Google Code-on, hogy segítsd a további fejlesztést.';
...
$lang['about_app_license'] = 'TekhneeAppointments a GPLv3 licensz alatt áll. Az TekhneeAppointments forráskódját bármilyen módon használva beleegyezel az alábbi linken található felhasználási feltételekbe:';
