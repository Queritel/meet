...
$lang['step_one_title'] = 'Выберите мероприятие';
$lang['select_service'] = 'Выберите мероприятие';
$lang['select_provider'] = 'Выберите сотрудника';
$lang['duration'] = 'Длительность';
$lang['minutes'] = 'Минут';
$lang['price'] = 'Цена';
$lang['back'] = 'Предыдущий';
$lang['step_two_title'] = 'Выбор даты и времени';
...
$lang['about_app'] = 'О приложении TekhneeAppointments';
...
$lang['about_app_info'] = 'TekhneeAppointments хорошо настраиваемое веб приложение которое позволяет вашим заказчикам оформлять время предоставления услуг через интернет. Кроме того, имеется возможность синхронизации с вашими Google-календарями так что вы сможете использовать план заказанных мероприятий.';
$lang['current_version'] = 'Текущая версия';
$lang['support'] = 'Поддержка';
$lang['about_app_support'] = 'Если произошли проблемы с использованием TekhneeAppointments вы можете использовать официальную Google группу для поиска ответа. Вы можете также создать новый запрос на странице проекта в Google Code вопрос на странице Google Code для того, чтобы помочь проекту развиватся.';
...
$lang['about_app_license'] = 'TekhneeAppointments обладает лицензией GPLv3. При использовании кода приложения в любом случае вы соглашаетесь с условиями, описанными в следующей URL:';
