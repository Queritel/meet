...
$lang['about_app'] = 'TekhneeAppointmentsとは。';
...
$lang['about_app_info'] = 'TekhneeAppointmentsは、カスタマイズ可能な予約受付ウエッブアップリケーションです。さら、Googleカレンダーとの連携ができるので、このシステムのスケジュールを他のシステムのスケジュールとまとめてみることができます。';
$lang['current_version'] = 'バージョン番号';
$lang['support'] = 'サポート';
$lang['about_app_support'] = ' TekhneeAppointments を利用する上で もし何か 問題がありましたら 、是非　公式 Google Groupを検索して 解決方法を見つけてください。もしかしたら 開発をさらに良いものにするために 新しい課題を Google Code に 登録することもできます。';
...
$lang['license'] = 'ライセンス';
$lang['about_app_license'] = 'TekhneeAppointments は　GPLv3 ライセンス に従います。 TekhneeAppointments　のプログラムコードを使用するということは、あるあらゆる面で 次のURLのサイトにある条件に同意したこととなります。:';
...
$lang['ea_update_success'] = 'TekhneeAppointments の　アップデートが成功しました。';
