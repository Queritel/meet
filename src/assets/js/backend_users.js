    ...
    function _bindEventHandlers() {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function () {
            if ($(this).attr('href') === '#admins') {
                ...
                var url = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_filter_providers' /* @/mangle */;
                var data = {
         ...
         */
        $(/* @mangle */ '#admin-username, #provider-username, #secretary-username' /* @/mangle */).focusout(function () {
            var $input = $(this);
            ...
            var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_validate_username' /* @/mangle */;
            var postData = {
                csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
                username: $input.val(),
                user_id: userId
