...
$(document).ready(function() {
  ...
  $.when(
    ...
    $("#timezone-selector").css("visibility", "visible");
    $("#timezone-selector").css("margin-bottom", "17px"); // Construct and mount HTML component.
    ...
    $(".js-Selector").on("change", function(e) {
      ...
      BackendCalendarDefaultView.renderCalendar(GlobalVariables.timezone);
