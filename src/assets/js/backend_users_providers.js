...
(function () {
    ...
    ProvidersHelper.prototype.bindEventHandlers = function () {
        ...
        $('#providers').on('click', '#save-provider', function () {
            var provider = {
                ...
                settings: {
                    username: $(/* @mangle */ '#provider-username' /* @/mangle */).val(),
    ...
    ProvidersHelper.prototype.save = function (provider) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_save_provider' /* @/mangle */;
        var postData = {
    ...
    ProvidersHelper.prototype.delete = function (id) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_delete_provider' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            provider_id: id
        };
    ...
    ProvidersHelper.prototype.validate = function () {
        ...
        try {
            ...
            if ($(/* @mangle */ '#provider-username' /* @/mangle */).attr('already-exists') == 'true') {
                $(/* @mangle */ '#provider-username' /* @/mangle */).closest('.form-group').addClass('has-error');
    ...
    ProvidersHelper.prototype.display = function (provider) {
        ...
        var dedicatedUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php?provider=' /* @/mangle */ + encodeURIComponent(provider.id);
        ...
        $.each(provider.services, function (index, serviceId) {
            $('#provider-services input:checkbox').each(function () {
                if ($(this).attr('data-id') == serviceId) {
                    ...
                    dedicatedUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php?provider=' /* @/mangle */ + encodeURIComponent(provider.id)
    ...
    ProvidersHelper.prototype.filter = function (key, selectId, display) {
        ...
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_filter_providers' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            key: key
        };
