...
(function () {
    ...
    SecretariesHelper.prototype.bindEventHandlers = function () {
        ...
        $('#secretaries').on('click', '#save-secretary', function () {
            var secretary = {
                ...
                settings: {
                    username: $(/* @mangle */ '#secretary-username' /* @/mangle */).val(),
    ...
    SecretariesHelper.prototype.save = function (secretary) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_save_secretary' /* @/mangle */;
        var postData = {
    ...
    SecretariesHelper.prototype.delete = function (id) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_delete_secretary' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            secretary_id: id
        };
    ...
    SecretariesHelper.prototype.validate = function () {
        ...
        try {
            ...
            if ($(/* @mangle */ '#secretary-username' /* @/mangle */).attr('already-exists') == 'true') {
                $(/* @mangle */ '#secretary-username' /* @/mangle */).closest('.form-group').addClass('has-error');
                throw /* @mangle */ 'Username already exists.' /* @/mangle */;
            }
    ...
    SecretariesHelper.prototype.filter = function (key, selectId, display) {
        ...
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_filter_secretaries' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            key: key
        };
