...
(function (exports) {
    ...
    exports.enableLanguageSelection = function ($element) {
        ...
        $.each(GlobalVariables.availableLanguages, function (l) {
            html += '<li class="language" data-language="' + l + '">'
                + GlobalVariables.availableLanguages[l][2] + '</li>';
        });
        html += '</ul>';
        ...
        $(document).on('click', 'li.language', function () {
            ...
            var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_change_language' /* @/mangle */;
            var postData = {
