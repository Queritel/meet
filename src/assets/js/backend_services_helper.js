...
(function () {
    ...
    ServicesHelper.prototype.bindEventHandlers = function () {
        ...
        $(document).on('click', '.service-row', function () {
            ...
            var dedicatedUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php?service=' /* @/mangle */ + encodeURIComponent(service.id);
    ...
    ServicesHelper.prototype.save = function (service) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_save_service' /* @/mangle */;
        var postData = {
    ...
    ServicesHelper.prototype.delete = function (id) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_delete_service' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            service_id: id
        };
    ...
    ServicesHelper.prototype.filter = function (key, selectId, display) {
        ...
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_filter_services' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            key: key
        };
