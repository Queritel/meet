...
(function () {
    ...
    CustomersHelper.prototype.save = function (customer) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_save_customer' /* @/mangle */;
        var postData = {
    ...
    CustomersHelper.prototype.delete = function (id) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_delete_customer' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            customer_id: id
        };
