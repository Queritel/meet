...
(function () {
    ...
    AdminsHelper.prototype.bindEventHandlers = function () {
        ...
        $('#admins').on('click', '#save-admin', function () {
            var admin = {
                ...
                settings: {
                    username: $(/* @mangle */ '#admin-username' /* @/mangle */).val(),
    ...
    AdminsHelper.prototype.save = function (admin) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_save_admin' /* @/mangle */;
        var postData = {
    ...
    AdminsHelper.prototype.delete = function (id) {
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_delete_admin' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            admin_id: id
        };
    ...
    AdminsHelper.prototype.validate = function () {
        ...
        try {
            ...
            if ($(/* @mangle */ '#admin-username' /* @/mangle */).attr('already-exists') == 'true') {
                $(/* @mangle */ '#admin-username' /* @/mangle */).closest('.form-group').addClass('has-error');
    ...
    AdminsHelper.prototype.filter = function (key, selectId, display) {
        ...
        var postUrl = GlobalVariables[/* @mangle */ 'baseUrl' /* @/mangle */ ] + /* @mangle */ '/index.php/backend_api/ajax_filter_admins' /* @/mangle */;
        var postData = {
            csrfToken: GlobalVariables[/* @mangle */ 'csrfToken' /* @/mangle */ ],
            key: key
        };
