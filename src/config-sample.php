...
/**
 * TekhneeAppointments Configuration File
 *
...
class Config {
    ...
    const BASE_URL      = 'http://url-to-TekhneeAppointments-directory';
    const LANGUAGE      = 'en'; // This should be one of the abbreviated language array key.
